...
public class TheaterAPI {
    ...
    @GetMapping("/theater")
    public ResponseEntity<Page<TheaterResponseDTO>> UserAll(@RequestParam(name = "keyword") String keyword,
    ...
    @PostMapping("/theater")
    public ResponseEntity<?> createTheater(@ModelAttribute TheaterRequestDTO theaterRequestDTO)throws CustomException{
